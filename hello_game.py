...
class Game:
       ...
       def update(self):
              ...
              def draw(self, screen):
                screen.fill(BLACK)
                pygame.draw.circle (screen, WHITE, (self.ball.xself.ball.y ), BALL_RADIUS)
                pygame.draw.rect (screen, WHITE (self.ball.x,self.paddle.y, self.paddle.width, self.paddle.height))
                ...
                if self.game_over:
                     ...
                     screen.bilt (game_over_text, game_over_rect)
              def main(): 
                   pygame.init()
